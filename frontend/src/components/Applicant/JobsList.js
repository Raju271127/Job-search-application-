...
class JobsList extends Component {
    ...
    onSOPsubmit(job)
    {
        ...
        {
            axios
                .post('https://job-search-applicatoin-api.onrender.com/application/add_application', newApplication)
                .then(response => {
            ...
            axios
                .put('https://job-search-applicatoin-api.onrender.com/user/edit_profile/' + user.id, editApplicant)
                .then(response => {
