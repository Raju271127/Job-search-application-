...
class MyActiveJobs extends Component {
    ...
    deljob(id) {
        ...
        axios
            .delete('https://job-search-applicatoin-api.onrender.com/job/del_job/' + id)
            .then(response => {
        ...
        applicationsArray.filter(item => item.jobId === id && item.status === "Accepted").forEach(
            function(appli) 
            {
                ...
                axios
                    .put('https://job-search-applicatoin-api.onrender.com/user/edit_profile/' + appli.applicantId, editEmployee)
                    .then(response => {
        ...
        applicationsArray.filter(item => item.jobId === id).forEach(
            function(appli) 
            {
                ...
                axios
                    .put('https://job-search-applicatoin-api.onrender.com/user/edit_profile/' + appli.applicantId, editApplicant)
                    .then(response => {
    ...
    editJobSubmit(job) {
        ...
        else
        {
            ...
            axios
                .put('https://job-search-applicatoin-api.onrender.com/job/edit_job/' + idToChange, this.state.jobs[ind])
                .then(response => {
